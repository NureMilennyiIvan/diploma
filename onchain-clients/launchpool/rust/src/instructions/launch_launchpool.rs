...
impl LaunchLaunchpool {
  pub fn instruction(&self, args: LaunchLaunchpoolInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: LaunchLaunchpoolInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&LaunchLaunchpoolInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct LaunchLaunchpoolInstructionData {
            discriminator: [u8; 8],
            }

impl LaunchLaunchpoolInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [97, 196, 50, 30, 168, 108, 120, 59],
                                }
  }
}

impl Default for LaunchLaunchpoolInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct LaunchLaunchpoolInstructionArgs {
                  pub start_timestamp: u64,
      }


/// Instruction builder for `LaunchLaunchpool`.
///
/// ### Accounts:
///
...
pub struct LaunchLaunchpoolBuilder {
...
impl LaunchLaunchpoolBuilder {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = LaunchLaunchpool {
          ...
          let args = LaunchLaunchpoolInstructionArgs {
                                                              start_timestamp: self.start_timestamp.clone().expect("start_timestamp is not set"),
                                    };
  ...
  /// `launch_launchpool` CPI accounts.
  pub struct LaunchLaunchpoolCpiAccounts<'a, 'b> {
...
/// `launch_launchpool` CPI instruction.
pub struct LaunchLaunchpoolCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: LaunchLaunchpoolInstructionArgs,
  }

impl<'a, 'b> LaunchLaunchpoolCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: LaunchLaunchpoolCpiAccounts<'a, 'b>,
              args: LaunchLaunchpoolInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `LaunchLaunchpool` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
          ...
          ///   3. `[]` reward_mint
                ...
                ///   5. `[writable]` reward_vault
#[derive(Clone, Debug)]
pub struct LaunchLaunchpoolCpiBuilder<'a, 'b> {
  instruction: Box<LaunchLaunchpoolCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> LaunchLaunchpoolCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(LaunchLaunchpoolCpiBuilderInstruction {
      __program: program,
              authority: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = LaunchLaunchpoolInstructionArgs {
                                                              start_timestamp: self.instruction.start_timestamp.clone().expect("start_timestamp is not set"),
                                    };
        let instruction = LaunchLaunchpoolCpi {
...
#[derive(Clone, Debug)]
struct LaunchLaunchpoolCpiBuilderInstruction<'a, 'b> {
