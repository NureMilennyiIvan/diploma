...
/// Accounts.
#[derive(Debug)]
pub struct UpdateLaunchpoolsConfigRewardAuthority {
...
impl UpdateLaunchpoolsConfigRewardAuthority {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = borsh::to_vec(&UpdateLaunchpoolsConfigRewardAuthorityInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct UpdateLaunchpoolsConfigRewardAuthorityInstructionData {
            discriminator: [u8; 8],
      }

impl UpdateLaunchpoolsConfigRewardAuthorityInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [129, 70, 231, 58, 103, 47, 83, 57],
                  }
  }
}

impl Default for UpdateLaunchpoolsConfigRewardAuthorityInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `UpdateLaunchpoolsConfigRewardAuthority`.
///
/// ### Accounts:
///
...
pub struct UpdateLaunchpoolsConfigRewardAuthorityBuilder {
...
impl UpdateLaunchpoolsConfigRewardAuthorityBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = UpdateLaunchpoolsConfigRewardAuthority {
  ...
  /// `update_launchpools_config_reward_authority` CPI accounts.
  pub struct UpdateLaunchpoolsConfigRewardAuthorityCpiAccounts<'a, 'b> {
...
/// `update_launchpools_config_reward_authority` CPI instruction.
pub struct UpdateLaunchpoolsConfigRewardAuthorityCpi<'a, 'b> {
...
impl<'a, 'b> UpdateLaunchpoolsConfigRewardAuthorityCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: UpdateLaunchpoolsConfigRewardAuthorityCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `UpdateLaunchpoolsConfigRewardAuthority` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
          ...
          ///   3. `[]` new_reward_authority
#[derive(Clone, Debug)]
pub struct UpdateLaunchpoolsConfigRewardAuthorityCpiBuilder<'a, 'b> {
  instruction: Box<UpdateLaunchpoolsConfigRewardAuthorityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdateLaunchpoolsConfigRewardAuthorityCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(UpdateLaunchpoolsConfigRewardAuthorityCpiBuilderInstruction {
      __program: program,
              authority: None,
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        let instruction = UpdateLaunchpoolsConfigRewardAuthorityCpi {
...
#[derive(Clone, Debug)]
struct UpdateLaunchpoolsConfigRewardAuthorityCpiBuilderInstruction<'a, 'b> {
