...
impl OpenStakePosition {
  pub fn instruction(&self, args: OpenStakePositionInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: OpenStakePositionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&OpenStakePositionInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct OpenStakePositionInstructionData {
            discriminator: [u8; 8],
            }

impl OpenStakePositionInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [100, 46, 32, 248, 0, 29, 122, 21],
                                }
  }
}

impl Default for OpenStakePositionInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct OpenStakePositionInstructionArgs {
                  pub stake_amount: u64,
      }


/// Instruction builder for `OpenStakePosition`.
///
/// ### Accounts:
///
          ...
          ///   9. `[]` stakable_token_program
#[derive(Clone, Debug, Default)]
pub struct OpenStakePositionBuilder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = OpenStakePosition {
          ...
          let args = OpenStakePositionInstructionArgs {
  ...
  /// `open_stake_position` CPI accounts.
  pub struct OpenStakePositionCpiAccounts<'a, 'b> {
...
/// `open_stake_position` CPI instruction.
pub struct OpenStakePositionCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: OpenStakePositionInstructionArgs,
  }

impl<'a, 'b> OpenStakePositionCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: OpenStakePositionCpiAccounts<'a, 'b>,
              args: OpenStakePositionInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `OpenStakePosition` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` signer
          ...
          ///   9. `[]` stakable_token_program
#[derive(Clone, Debug)]
pub struct OpenStakePositionCpiBuilder<'a, 'b> {
  instruction: Box<OpenStakePositionCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> OpenStakePositionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(OpenStakePositionCpiBuilderInstruction {
      __program: program,
              signer: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = OpenStakePositionCpi {
...
#[derive(Clone, Debug)]
struct OpenStakePositionCpiBuilderInstruction<'a, 'b> {
