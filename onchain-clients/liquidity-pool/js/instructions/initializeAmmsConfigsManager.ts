...
export type InitializeAmmsConfigsManagerInstruction<
  ...
  TAccountLiquidityPoolProgram extends
    | string
    | IAccountMeta<string> = '2M2QKXZuuERizynTpUwfD7FkdhKHWAFVKiCFGBSxXr3X',
  ...
  IInstructionWithAccounts<
    [
      ...
      TAccountProgramData extends string
        ...
        : TAccountProgramData,
      TAccountLiquidityPoolProgram extends string
        ? ReadonlyAccount<TAccountLiquidityPoolProgram>
        : TAccountLiquidityPoolProgram,
...
export type InitializeAmmsConfigsManagerAsyncInput<
  ...
  TAccountLiquidityPoolProgram extends string = string,
...
> = {
  ...
  liquidityPoolProgram?: Address<TAccountLiquidityPoolProgram>;
...
> {
  ...
  const originalAccounts = {
    ...
    liquidityPoolProgram: {
      value: input.liquidityPoolProgram ?? null,
      isWritable: false,
    },
  ...
  if (!accounts.liquidityPoolProgram.value) {
    accounts.liquidityPoolProgram.value =
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.liquidityPoolProgram),
...
> = {
  ...
  accounts: {
    ...
    liquidityPoolProgram: TAccountMetas[5];
...
>(
  ...
  return {
    ...
    accounts: {
      ...
      liquidityPoolProgram: getNextAccount(),
      rent: getNextAccount(),
