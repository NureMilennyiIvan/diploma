...
impl SwapInCpAmm {
  pub fn instruction(&self, args: SwapInCpAmmInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SwapInCpAmmInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&SwapInCpAmmInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SwapInCpAmmInstructionData {
            discriminator: [u8; 8],
                              }

impl SwapInCpAmmInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [61, 164, 214, 168, 232, 232, 147, 137],
                                                                          }
  }
}

impl Default for SwapInCpAmmInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SwapInCpAmmInstructionArgs {
                  pub swap_amount: u64,
...
/// Instruction builder for `SwapInCpAmm`.
///
/// ### Accounts:
///
          ...
          ///   1. `[]` base_mint
          ///   2. `[]` quote_mint
                ///   3. `[writable]` signer_base_account
                ///   4. `[writable]` signer_quote_account
          ///   5. `[]` amms_config
                ///   6. `[writable]` cp_amm
                ///   7. `[writable]` cp_amm_base_vault
                ///   8. `[writable]` cp_amm_quote_vault
...
pub struct SwapInCpAmmBuilder {
            signer: Option<solana_program::pubkey::Pubkey>,
                ...
                estimated_result: Option<u64>,
                allowed_slippage: Option<u64>,
                is_in_out: Option<bool>,
        __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl SwapInCpAmmBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
    pub fn system_program(&mut self, system_program: solana_program::pubkey::Pubkey) -> &mut Self {
      ...
      pub fn swap_amount(&mut self, swap_amount: u64) -> &mut Self {
        ...
        self
                ...
                #[inline(always)]
      pub fn estimated_result(&mut self, estimated_result: u64) -> &mut Self {
        self.estimated_result = Some(estimated_result);
        self
      }
                #[inline(always)]
      pub fn allowed_slippage(&mut self, allowed_slippage: u64) -> &mut Self {
        self.allowed_slippage = Some(allowed_slippage);
        self
      }
                #[inline(always)]
      pub fn is_in_out(&mut self, is_in_out: bool) -> &mut Self {
        self.is_in_out = Some(is_in_out);
        self
      }
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SwapInCpAmm {
          ...
          let args = SwapInCpAmmInstructionArgs {
                                                              swap_amount: self.swap_amount.clone().expect("swap_amount is not set"),
                                                                  estimated_result: self.estimated_result.clone().expect("estimated_result is not set"),
                                                                  allowed_slippage: self.allowed_slippage.clone().expect("allowed_slippage is not set"),
                                                                  is_in_out: self.is_in_out.clone().expect("is_in_out is not set"),
                                    };
  ...
  /// `swap_in_cp_amm` CPI accounts.
  pub struct SwapInCpAmmCpiAccounts<'a, 'b> {
...
/// `swap_in_cp_amm` CPI instruction.
pub struct SwapInCpAmmCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: SwapInCpAmmInstructionArgs,
  }

impl<'a, 'b> SwapInCpAmmCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: SwapInCpAmmCpiAccounts<'a, 'b>,
              args: SwapInCpAmmInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `SwapInCpAmm` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` signer
          ...
          ///   12. `[]` system_program
#[derive(Clone, Debug)]
pub struct SwapInCpAmmCpiBuilder<'a, 'b> {
  instruction: Box<SwapInCpAmmCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SwapInCpAmmCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SwapInCpAmmCpiBuilderInstruction {
      __program: program,
              signer: None,
              base_mint: None,
              quote_mint: None,
    ...
    pub fn system_program(&mut self, system_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      pub fn swap_amount(&mut self, swap_amount: u64) -> &mut Self {
        ...
        self
                ...
                #[inline(always)]
      pub fn estimated_result(&mut self, estimated_result: u64) -> &mut Self {
        self.instruction.estimated_result = Some(estimated_result);
        self
      }
                #[inline(always)]
      pub fn allowed_slippage(&mut self, allowed_slippage: u64) -> &mut Self {
        self.instruction.allowed_slippage = Some(allowed_slippage);
        self
      }
                #[inline(always)]
      pub fn is_in_out(&mut self, is_in_out: bool) -> &mut Self {
        self.instruction.is_in_out = Some(is_in_out);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = SwapInCpAmmInstructionArgs {
                                                              swap_amount: self.instruction.swap_amount.clone().expect("swap_amount is not set"),
                                                                  estimated_result: self.instruction.estimated_result.clone().expect("estimated_result is not set"),
                                                                  allowed_slippage: self.instruction.allowed_slippage.clone().expect("allowed_slippage is not set"),
                                                                  is_in_out: self.instruction.is_in_out.clone().expect("is_in_out is not set"),
                                    };
        let instruction = SwapInCpAmmCpi {
...
#[derive(Clone, Debug)]
struct SwapInCpAmmCpiBuilderInstruction<'a, 'b> {
