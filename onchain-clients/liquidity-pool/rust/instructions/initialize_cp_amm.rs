...
impl InitializeCpAmm {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = borsh::to_vec(&InitializeCpAmmInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InitializeCpAmmInstructionData {
            discriminator: [u8; 8],
      }

impl InitializeCpAmmInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [87, 106, 187, 127, 21, 15, 52, 8],
                  }
  }
}

impl Default for InitializeCpAmmInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `InitializeCpAmm`.
///
/// ### Accounts:
///
          ...
          ///   2. `[]` base_mint
          ///   3. `[]` quote_mint
                      ///   4. `[writable, signer]` lp_mint
          ///   5. `[]` amms_config
                ///   6. `[writable]` cp_amm
                ///   7. `[writable]` cp_amm_base_vault
                ///   8. `[writable]` cp_amm_quote_vault
                ///   9. `[writable]` cp_amm_locked_lp_vault
...
pub struct InitializeCpAmmBuilder {
...
#[inline(always)]
  ...
  /// `initialize_cp_amm` CPI accounts.
  pub struct InitializeCpAmmCpiAccounts<'a, 'b> {
...
/// `initialize_cp_amm` CPI instruction.
pub struct InitializeCpAmmCpi<'a, 'b> {
...
impl<'a, 'b> InitializeCpAmmCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: InitializeCpAmmCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `InitializeCpAmm` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` signer
          ...
          ///   14. `[]` quote_token_program
#[derive(Clone, Debug)]
pub struct InitializeCpAmmCpiBuilder<'a, 'b> {
  instruction: Box<InitializeCpAmmCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InitializeCpAmmCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(InitializeCpAmmCpiBuilderInstruction {
      __program: program,
              signer: None,
              fee_authority: None,
              base_mint: None,
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        let instruction = InitializeCpAmmCpi {
...
#[derive(Clone, Debug)]
struct InitializeCpAmmCpiBuilderInstruction<'a, 'b> {
