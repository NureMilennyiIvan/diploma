...
impl WithdrawFromCpAmm {
  pub fn instruction(&self, args: WithdrawFromCpAmmInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: WithdrawFromCpAmmInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&WithdrawFromCpAmmInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct WithdrawFromCpAmmInstructionData {
            discriminator: [u8; 8],
            }

impl WithdrawFromCpAmmInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [199, 54, 177, 131, 202, 241, 176, 155],
                                }
  }
}

impl Default for WithdrawFromCpAmmInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct WithdrawFromCpAmmInstructionArgs {
                  pub lp_tokens: u64,
      }


/// Instruction builder for `WithdrawFromCpAmm`.
///
/// ### Accounts:
///
...
pub struct WithdrawFromCpAmmBuilder {
            signer: Option<solana_program::pubkey::Pubkey>,
                ...
                system_program: Option<solana_program::pubkey::Pubkey>,
                        lp_tokens: Option<u64>,
        __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl WithdrawFromCpAmmBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
    pub fn system_program(&mut self, system_program: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn lp_tokens(&mut self, lp_tokens: u64) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = WithdrawFromCpAmm {
          ...
          let args = WithdrawFromCpAmmInstructionArgs {
                                                              lp_tokens: self.lp_tokens.clone().expect("lp_tokens is not set"),
                                    };
  ...
  /// `withdraw_from_cp_amm` CPI accounts.
  pub struct WithdrawFromCpAmmCpiAccounts<'a, 'b> {
...
/// `withdraw_from_cp_amm` CPI instruction.
pub struct WithdrawFromCpAmmCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: WithdrawFromCpAmmInstructionArgs,
  }

impl<'a, 'b> WithdrawFromCpAmmCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: WithdrawFromCpAmmCpiAccounts<'a, 'b>,
              args: WithdrawFromCpAmmInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `WithdrawFromCpAmm` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` signer
          ...
          ///   15. `[]` system_program
#[derive(Clone, Debug)]
pub struct WithdrawFromCpAmmCpiBuilder<'a, 'b> {
  instruction: Box<WithdrawFromCpAmmCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WithdrawFromCpAmmCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(WithdrawFromCpAmmCpiBuilderInstruction {
      __program: program,
              signer: None,
              base_mint: None,
              quote_mint: None,
    ...
    pub fn system_program(&mut self, system_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn lp_tokens(&mut self, lp_tokens: u64) -> &mut Self {
        self.instruction.lp_tokens = Some(lp_tokens);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = WithdrawFromCpAmmInstructionArgs {
                                                              lp_tokens: self.instruction.lp_tokens.clone().expect("lp_tokens is not set"),
                                    };
        let instruction = WithdrawFromCpAmmCpi {
...
#[derive(Clone, Debug)]
struct WithdrawFromCpAmmCpiBuilderInstruction<'a, 'b> {
